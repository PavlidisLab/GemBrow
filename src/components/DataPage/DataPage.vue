    ...
    <v-layout row wrap class="elevation-1">
        ...
        <v-layout row wrap>
            <v-flex xs12 wrap :class="this.longClass" order-xs3 order-md1>
                <v-layout row wrap>
                    <v-flex xs12>
                      ...
                      (col) =>
                        !col.adminOnly ||
                        (col.adminOnly && user && user.isAdmin)
                    )"
                ...
                <span :title="props.header.tip">{{
                        props.header.labelMain
                                ? props.header.labelMain
                                : props.header.label
                    }}</span>
                            </template>
                            <template slot="items" slot-scope="props">
                                <tr v-on:click="props.expanded = !props.expanded">
                                    <td
                                            ...
                                            v-show="
                      visibleCols.includes(col.label) &&
                      (!col.adminOnly ||
                        (col.adminOnly && user && user.isAdmin))
                    "
                                    >
            ...
            <v-flex
                    ...
                    xs12
                    class="help"
                    :class="settingsVisible && settingsHelpVisible ? 'md3' : 'md0'"
                    v-show="settingsVisible && settingsHelpVisible"
                    order-xs1
                    order-md3
            >
                <v-card
