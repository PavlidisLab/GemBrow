        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <h4 style="font-weight: normal">How do the browser's filter options work?</h4>
                    <p> There are three main categories you can use to filter data: Taxa, Platforms, and Annotations. Annotations is further divided into groupings which behave similarly to categories. </p>
